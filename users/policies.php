    ...
    <nav class="navbar">
        <div class="nav-container">
            ...
            <ul class="nav-links">
                ...
                <li><a href="policies.php" style="color: var(--primary-color);">Policies</a></li>
                    ...
                    <div class="policy-card">
                        ...
                        <div class="policy-body">
                            ...
                            <div class="policy-actions">
                                ...
                                <?php endif; ?>
                                <a href="users/claims.php?policy_id=<?php echo $policy['Id']; ?>" class="btn btn-outline btn-sm">
